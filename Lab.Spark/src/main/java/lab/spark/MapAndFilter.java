...
public class MapAndFilter extends CommonSparkConfig {
	...
	public void readLocalFileSystem() {
	...
	SQLContext sqlContext = SQLContext.getOrCreate(this.sparkSession.sparkContext());
